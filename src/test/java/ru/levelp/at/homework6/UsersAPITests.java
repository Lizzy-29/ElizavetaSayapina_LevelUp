...
public class UsersAPITests {
    ...
    void getUsers() {
        RestAssured.when()
                   ...
                   .body("data.name", Matchers.hasItems("Achintya Tagore", "Draupadi Patil", "Chandrakala Prajapat",
                       "Aishani Ahuja CPA", "Bhilangana Varman", "Govinda Kapoor", "Lai Trivedi LLD", "Triloki Devar",
                       "Vedang Mukhopadhyay Esq.", "Rohana Tandon"))
                   .body("data.email",
                       Matchers.hasItems("tagore_achintya@hamill.name", "patil_draupadi@schinner-heaney.name",
                           "chandrakala_prajapat@bradtke.biz", "aishani_cpa_ahuja@batz-ferry.biz",
                           "bhilangana_varman@beer-heidenreich.com", "kapoor_govinda@kshlerin.co",
                           "trivedi_lai_lld@kuphal-bartell.name", "triloki_devar@cole.name",
                           "vedang_esq_mukhopadhyay@von.io", "tandon_rohana@simonis-powlowski.org"))
    ...
    void patchUsersUserId() {
        RestAssured.given()
                   .log().all()
                   .auth().oauth2("7e0bc0838979483dad3d8aeeee898070e60824998367b509f36451d9cea03941")
                   .param("name", "Mary Ruskin")
                   .param("gender", "female")
                   .param("status", "inactive")
                   .when()
                   .patch("https://gorest.co.in/public-api/users/2453")
                   .then()
                   .log().all()
                   .statusCode(200)
                   .body("data.name", Matchers.equalTo("Mary Ruskin"))
                   .body("data.email", Matchers.equalTo("ganaka_aanjaneya@okuneva.biz"))
                   .body("data.gender", Matchers.equalTo("female"))
                   .body("data.status", Matchers.equalTo("inactive"));
    }
    ...
    void deleteUsersUserId() {
        RestAssured.given()
                   ...
                   .auth().oauth2("7e0bc0838979483dad3d8aeeee898070e60824998367b509f36451d9cea03941")
                   .when()
                   .delete("https://gorest.co.in/public-api/users/2468")
                   .then()
                   .log().all()
                   .statusCode(200)
